...
const SECTIONS = [
  ...
  { name: 'ielts-speaking', active: true, pages: 4 },
  { name: 'ielts-listening', active: true, pages: 12 },
  { name: 'level2', active: true, pages: 15 },
  ...
  { name: 'the-balance-theory-podcast', active: true, pages: 2 },
  { name: 'ielts-60-speaking-topics', active: true, pages: 10 },
  { name: 'slow-podcast', active: true, pages: 3 },
  { name: 'english-newspaper', active: true, pages: 2 },
  { name: 'on-purpose-podcast', active: true, pages: 2 },
];
